...
class ImageResBuilder implements Builder {
  ...
  /// The path of custom [ImageProvider] class to be extended
  late String customImageProviderPath;

  /// The custom [ImageProvider] class to be extended
  late String customImageProviderClass;
...
import '$customImageProviderPath';
...
class AssetGenImage extends $customImageProviderClass {
